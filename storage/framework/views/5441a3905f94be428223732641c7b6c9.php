...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200"><?php echo e(__('Sesiones del Navegador')); ?></h2>
     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <p class="text-gray-600 dark:text-gray-400"><?php echo e(__('Administra y cierra las sesiones activas en otros navegadores y dispositivos.')); ?></p>
     <?php $__env->endSlot(); ?>

     <?php $__env->slot('content', null, []); ?> 
        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__('Si es necesario, puedes cerrar la sesión en todos los otros navegadores en todos tus dispositivos. A continuación, se muestra una lista de algunas de tus sesiones recientes, aunque esta lista puede no ser exhaustiva. Si crees que tu cuenta ha sido comprometida, también debes cambiar tu contraseña.')); ?>
...
<?php $component->withAttributes(['wire:click' => 'confirmLogout','wire:loading.attr' => 'disabled']); ?>
                <?php echo e(__('Cerrar Sesiones en Otros Navegadores')); ?>
...
<?php $component->withAttributes(['wire:model' => 'confirmingLogout']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <?php echo e(__('Por favor, ingresa tu contraseña para confirmar que deseas cerrar las sesiones en otros navegadores en todos tus dispositivos.')); ?>


                <div class="mt-4" x-data="{}" x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
                    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => ''.e(__('Contraseña')).'','xRef' => 'password','wire:model.defer' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => ''.e(__('Contraseña')).'','x-ref' => 'password','wire:model.defer' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\Users\Julio\Downloads\TiendaRopa-main\TiendaRopa-main\resources\views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>