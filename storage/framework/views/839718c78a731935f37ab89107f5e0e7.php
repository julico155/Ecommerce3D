...
<?php endif; ?>
                        ...
                        <form method="POST" action="<?php echo e(route('password.email')); ?>">
                            ...
                            <div class="mb-3">
                                <label for="email" class="form-label"><?php echo e(__('Correo Electronico')); ?></label>
                                <input id="email" type="email" class="form-control" name="email" :value="old('email')" required autofocus autocomplete="username">
                            </div>
                            <br>
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary"><?php echo e(__('Enviar enlace de restablecimiento de contraseña')); ?></button>
                            </div>
                        </form>
                        <br>
                        <br>
...
<?php endif; ?>
<?php /**PATH F:\Proyectos\SI2\TiendaRopa\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>