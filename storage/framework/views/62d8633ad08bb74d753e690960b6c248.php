...
<div class="container mx-auto px-4 my-4">
    ...
    <div class="w-full lg:w-3/4 mx-auto mb-4">
        ...
        <form action="<?php echo e(route('talla.store')); ?>" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <?php echo csrf_field(); ?>
            ...
            <table class="min-w-full border border-gray-200 mt-4">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $tallas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $talla): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php if($talla->tipo_talla_numero): ?>
                            <tr>
                                ...
                                <td class="text-center py-2 px-4 border-b">
                                    <p class="font-semibold text-center">
                                        <?php echo e($talla->tipo_talla_numero); ?>

                                    </p>
                                </td>

                                <td class="text-center py-2 px-4 border-b">
                                    <a href="<?php echo e(route('talla.edit', $talla->id)); ?>"
                                        class="text-green-500 hover:text-green-700 mr-2">
                                        Edit
                                    </a>
                                    <form action="<?php echo e(route('talla.destroy', $talla->id)); ?>" method="POST"
                                        class="inline-block">
                                        <?php echo csrf_field(); ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $tallas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $talla): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php if($talla->tipo_talla_letra): ?>
                        <tr>
                            ...
                            <td class="text-center py-2 px-4 border-b">
                                <p class="font-semibold text-center">
                                    <?php echo e($talla->tipo_talla_letra); ?>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Julio\Downloads\TiendaRopa-main\TiendaRopa-main\resources\views/VistaTalla/index.blade.php ENDPATH**/ ?>