    ...
    <div class="container mx-auto px-4 my-4">
        <div class="flex flex-col items-center sm:flex-row">
            <div class="mt-4 sm:ml-4 space-x-4">
                ...
                <a href="<?php echo e(route('marca.index')); ?>" class="bg-gray-400 hover:bg-gray-700 text-white px-4 py-2 rounded-md transition duration-300">
                    Marcas
                </a>
            </div>
        </div>
                ...
                <?php $__currentLoopData = $categoria->productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white p-4 shadow-md">
                        <div class="grid grid-cols-[1fr,3fr]">
                            <div>
                                <img src="<?php echo e(asset($producto->imagen1)); ?>" alt="Foto del producto" class="w-24 h-24 mb-2">
                                <a href="<?php echo e(route('indexproducto.edit', $producto->id)); ?>"
                            ...
                            <div class="ml-4">
                                ...
                                <form action="<?php echo e(route('indexproducto.destroy', $producto->id)); ?>" method="POST"
                                    class="inline-block">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Proyectos\SI2\TiendaRopa\resources\views/Vistaadministracion/index.blade.php ENDPATH**/ ?>