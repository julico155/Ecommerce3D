<?php $__env->startSection('producto'); ?>
        <div class="w-full lg:w-1/2 mx-auto my-4">
            ...
            <h2 class="text-2xl font-bold text-black mt-8 mb-4 ml-4 uppercase">Actualizar Categoria:</h2>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Proyectos\SI2\TiendaRopa\resources\views/VistaCategoria/edit.blade.php ENDPATH**/ ?>