...
@section('cliente')
    <div class="relative bg-cover bg-center bg-opacity-60"
        style="background-image: url('{{ asset('img/fondo-principal.jpg') }}');">
    ...
    <div class="bg-white py-8">
        ...
        <div class="container mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 px-4 text-center">
            @foreach ($productos as $producto)
                <div class="bg-white rounded-2xl p-4 flex flex-col items-center transition transform duration-300 ease-in-out hover:-translate-y-1 hover:shadow-2xl ">
                    <a href="{{ route('producto.show', $producto) }}"
                        ...
                        <div class="relative">
                            ...
                            <div
                                class="absolute top-2 right-2 py-1 px-1 rounded-full text-xs font-bold
                        @if ($producto->stock > 0) bg-green-500 text-white
                        @else
                    ...
                    ">
                            ...
                            @if ($producto->es_3d)
                                <div
                                    class="absolute top-2 left-2 py-1 px-2 rounded-full text-xs font-bold bg-blue-500 text-white">
                                    3D
                                </div>
                            @endif
                        </div>
                    ...
                    @if ($producto->stock > 0) bg-green-500 text-white rounded-full hover:bg-green-600 hover:bg-green-600
                        transition duration-300 ease-in-out
                    @else
                        bg-red-500 text-white rounded-full hover:bg-red-600 hover:bg-red-600
                        transition duration-300 ease-in-out @endif">
                            Comprar
                        </button>
                    </a>
                </div>
        ...
        <div class="text-center mt-8">
            <a href="{{ route('ver-producto') }}"
                class="inline-block px-4 py-2 text-white bg-blue-500 rounded-full hover:bg-blue-600 transition duration-300">
                Ver más productos
            </a>
        </div>
    </div>
    ...
    <section class="bg-gray-100 p-16">
        <div class="container mx-auto flex items-center justify-between">
            <div class="w-1/2">
                ...
                <p class="text-gray-700 leading-relaxed">Estamos aquí para ayudarte con tus necesidades. ¡Contáctanos para
                ...
                <ul class="mt-4 space-y-2">
                    ...
                    <li class="flex items-center">
                        <i class="fas fa-map-marker-alt text-lg text-blue-500 mr-2"></i> Dirección: Santa Cruz de la sierra
                        - Bolivia, Av. Libertad
                    </li>
                </ul>
            </div>
