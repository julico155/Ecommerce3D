...
<?php $component->withAttributes(['submit' => 'updateProfileInformation']); ?>
     <?php $__env->slot('title', null, []); ?> 
        <div class="text-2xl font-semibold text-gray-800 dark:text-gray-200"><?php echo e(__('Información de Perfil')); ?></div>
     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <div class="text-gray-600 dark:text-gray-400"><?php echo e(__('Actualiza la información de tu perfil y dirección de correo electrónico.')); ?></div>
     <?php $__env->endSlot(); ?>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <?php if(Laravel\Jetstream\Jetstream::managesProfilePhotos()): ?>
                <div x-data="{ photoName: null, photoPreview: null }">
                    ...
                    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'photo','value' => ''.e(__('Foto de Perfil')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'photo','value' => ''.e(__('Foto de Perfil')).'']); ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['class' => 'mt-2','type' => 'button','xOn:click.prevent' => '$refs.photo.click()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-2','type' => 'button','x-on:click.prevent' => '$refs.photo.click()']); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH F:\Proyectos\SI2\TiendaRopa\resources\views/profile/update-profile-information-form.blade.php ENDPATH**/ ?>